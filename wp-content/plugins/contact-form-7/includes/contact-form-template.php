...
function wpcf7_messages() {
	$messages = array(
		'mail_sent_ok' => array(
			...
			'default'
				=> __( "Chúng tôi đã nhận được thông tin của bạn. Chúng tôi sẽ liên hệ lại trong thời gian sớm nhất", 'contact-form-7' )
		),
		...
		'mail_sent_ng' => array(
			...
			'default'
				=> __( "Có lỗi khi cố gắng gửi thông điệp của bạn. Vui lòng thử lại sau.", 'contact-form-7' )
		),
		...
		'validation_error' => array(
			...
			'default'
				=> __( "Một hoặc nhiều trường xảy ra lỗi. Vui lòng kiểm tra và thử lại.", 'contact-form-7' )
		),
		...
		'accept_terms' => array(
			...
			'default'
				=> __( "Bạn phải chấp nhận các điều khoản và điều kiện trước khi gửi tin nhắn của bạn.", 'contact-form-7' )
		),
		...
		'invalid_required' => array(
			...
			'default'
				=> __( "Vui lòng nhập thông tin.", 'contact-form-7' )
		),
		...
		'invalid_too_long' => array(
			...
			'default'
				=> __( "Thông tin quá dài.", 'contact-form-7' )
		),
		...
		'invalid_too_short' => array(
			...
			'default'
				=> __( "Thông tin quá ngắn.", 'contact-form-7' )
		)
	);
