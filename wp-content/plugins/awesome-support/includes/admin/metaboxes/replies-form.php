...
<div class="wpas-reply-actions">
	...
	switch ( $where ):
		...
		case 'back': ?>
			...
			<button type="submit" name="wpas_do" class="button-primary wpas_btn_reply" value="reply"><?php _e( 'Trả Lời', 'awesome-support' ); ?></button>
			<?php break;
		...
		case 'stay':
			?>
			<button type="submit" name="wpas_do" class="button-primary wpas_btn_reply" value="reply"><?php _e( 'Trả Lời', 'awesome-support' ); ?></button><?php
			break;
	...
	<?php if ( current_user_can( 'close_ticket' ) ): ?>
		<button type="submit" name="wpas_do" class="button-secondary wpas_btn_reply_close" value="reply_close"><?php _e( 'Trả Lời & Đóng', 'awesome-support' ); ?></button>
	<?php endif;
