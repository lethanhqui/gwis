 ...
 */
	...
	if ( $the_query->have_posts() ) {
		...
		if ( $llorix_one_lite_number_of_posts > 0 ) {
			?>
			<section class="timeline" id="latestnews" role="region" aria-label="<?php esc_html_e( 'Latest blog posts','llorix-one-lite' ); ?>">
					...
					<div class="container">
						<div class="row">
							...
							<div class="people-image">
								<div class="col-md-4 col-sm-4 people-item">
									<img src="<?php bloginfo('template_directory');?>/images/ld1.jpg">
									<div class="profile">
										<h4>Tiến sĩ Philip Nguyễn</h4>
										<p>Chủ tịch tập đoàn / Giám đốc điều hành</p>
									</div>
								</div>
								...
								<div class="col-md-4 col-sm-4 people-item">
									...
									<div class="profile">
										<h4>Tiến sĩ Robert Clegg</h4>
										<p> Phó chủ tịch phụ trách Phát triển <span>kinh doanh Quốc tế</span></p>
									</div>
								</div>
								...
								<div class="col-md-4 col-sm-4 people-item">
									...
									<div class="profile">
										<h4>Tiến sĩ John Meske</h4>
										<p>Cố vấn đào tạo</p>
									</div>
								</div>
								
								<div class="col-md-4 col-sm-4 people-item">
									<img src="<?php bloginfo('template_directory');?>/images/ld5.jpg">
									<div class="profile">
										<h4>Ông Trần Quốc Bình</h4>
										<p>Tổng Giám đốc Điều hành <span>GWIS tại Việt Nam</span></p>
									</div>
								</div>
								
								<div class="col-md-4 col-sm-4 people-item">
									<img src="<?php bloginfo('template_directory');?>/images/ld9.jpg">
									<div class="profile">
										<h4>Ông STANLEY N.LYONS</h4>
										<p>Phó Hiệu trưởng  <span>Khu vực Đông Nam Á</span></p>
									</div>
								</div>
								
								
								<div class="col-md-4 col-sm-4 people-item">
									<img src="<?php bloginfo('template_directory');?>/images/ld6.jpg">
									<div class="profile">
										<h4>Ông Võ Minh Đức</h4>
										<p>P.Tổng Giám đốc khu vực 1 <span>GWIS tại Việt Nam</span></p>
									</div>
								</div>
								
								<div class="col-md-4 col-sm-4 people-item">
									<img src="<?php bloginfo('template_directory');?>/images/ld7.jpg">
									<div class="profile">
										<h4>Bà Hồ Thị Diệu Liên</h4>
										<p>P.Tổng Giám đốc khu vực 2 <span>GWIS tại Việt Nam</span></p>
									</div>
								</div>
								
								<div class="col-md-4 col-sm-4 people-item">
									<img src="<?php bloginfo('template_directory');?>/images/ld8.jpg">
									<div class="profile">
										<h4>Bà Nguyễn Thị Mai</h4>
										<p>P.Tổng Giám đốc khu vực 3 <span>GWIS tại Việt Nam</span></p>
									</div>
								</div>
