...
function llorix_one_lite_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Notify', 'llorix-one-lite' ),
			'id'            => 'notify-1',
			'description'   => '',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'List_news', 'llorix-one-lite' ),
			'id'            => 'news-1',
			'description'   => '',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
...
function llorix_one_lite_scripts() {
	...
	wp_enqueue_style( 'llorix-one-lite-font', '//fonts.googleapis.com/css?family=Cabin:400,600|Open+Sans:400,300,600|Crimson+Text:400,400i,600,600i,700,700i' );
	...
	wp_enqueue_style( 'llorix-one-lite-custom-master-style', llorix_one_lite_get_file( '/css/custom-master.css' ), array(), '3.3.1' );
	
	wp_enqueue_style( 'llorix-one-lite-responsive-style', llorix_one_lite_get_file( '/css/responsive.css' ), array(), '3.3.1' );
