...
/* Custom LTQ */
jQuery(document).ready( function(){
	var text = jQuery('h1.page-title').text();
	text = text.replace("Category: ", "");
	jQuery('h1.page-title').text(text);
	
	 jQuery('.wpcf7-submit').click(function() {
		 
			
			var your_name = jQuery('input[name=your-name]').val();
			var your_email = jQuery('input[name=your-email]').val();
			var your_message = jQuery('textarea[name=your-message]').val();
			jQuery('.wpcf7-not-valid-tip').css('display','none');
			if(your_message == ''){
				jQuery('textarea[name=your-message]').css('border','1px solid red');
				jQuery('textarea[name=your-message]').focus();}
			else{
				jQuery('textarea[name=your-message]').css('border','0px solid red')
			}
			...
			if(your_email == ''){
				...
				jQuery('input[name=your-email]').css('border','0px solid red')
			}
			if(your_name == ''){
				jQuery('input[name=your-name]').css('border','1px solid red');
				jQuery('input[name=your-name]').focus();}
			else{
				jQuery('input[name=your-name]').css('border','0px solid red')
			}
    });
});
